            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about_us_left">
                        <h5>About us</h5>
                        <h2>Introducing 'Immi Tours'</h2>
                        <p>Immi Tours Limited strives to provide distinctive offerings and personalised service that caters to the specific requirements of each customer. Recognising that every reservation possesses distinct specifications,
