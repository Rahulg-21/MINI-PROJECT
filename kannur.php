...
<?php include 'components/navbar.php'; ?>
            ...
            <div class="tm-row">
                <div class="tm-col-left">
                    <section class="tm-content">
                        ...
                        <div class="media my-3 mb-5 tm-service-media tm-service-media-img-l">
                            <img src="img/Kannur.jpg" alt="Image" class="tm-service-img">
                ...
                <main class="tm-col-right">
                    ...
                    <section class="tm-content">
                        <div class="media my-3 mb-5 tm-service-media tm-service-media-img-l">
                            <img src="https://www.holidify.com/images/cmsuploads/square/1024px-Payyambalam_Beach_Back_Water_20180425181108.jpg" alt="Image" class="tm-service-img"> 
                        </div>
                        <section class="tm-content">
                            <!-- <hr class="mb-3"> -->
                        ...
                        <div class="media my-3 mb-5 tm-service-media tm-service-media-img-l">
                            <img src="https://www.holidify.com/images/cmsuploads/square/Muzhappilangad_Drive-in_Beach_2_20180526213558.jpg" alt="Image" class="tm-service-img">
                        </div>
                        <section class="tm-content">
                        ...
                        <div class="media my-3 mb-5 tm-service-media tm-service-media-img-l">
                            <img src="https://www.holidify.com/images/cmsuploads/square/arakkal_kettu_museum_kannur20131206112854_84_1_20180517135657.jpg" alt="Image" class="tm-service-img">
                        </div>
                        <section class="tm-content">
