...
<head>
    ...
    <!-- Title -->
    <title>Hotel booking - Immitours </title>
    <!-- Bootstrap css -->
...
<!--                                                 <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="hotel-booking.php" class="nav-link active">Hotel booking</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="train-booking.php" class="nav-link">Train booking</a>
                                        </li>
                            ...
                            <ul>
                                ...
                                <li class="dashboard_dropdown_button" id="dashboard_dropdowns"><i
                                    ...
                                    <div class="booing_sidebar_dashboard" id="show_dropdown_item"
                                        style="display: none;">
                                        <ul>
                                            <li><a href="hotel-booking.php" class="active"><i
                                ...
                                <li><a href="my-profile.php"><i class="fas fa-user-circle"></i>My profile</a></li>
