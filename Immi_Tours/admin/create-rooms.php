...
move_uploaded_file($_FILES["roomimages"]["tmp_name"],"roomimages/".$_FILES["roomimage"]["name"]);
$sql="INSERT INTO tbl_room(RoomName,RoomRating,RoomPrice,RoomImage) VALUES(:rname,:rrating,:rprice,:rimage)";
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Create Room </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="room" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="roomname" id="roomname" placeholder="Create Room" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Room Rating</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="roomrating" id="roomrating" placeholder=" rating eg- 2.5/5" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="roomprice" id="roomprice" placeholder="Price is USD" required>
									</div>
								</div>
