...
$sql ="delete from tbl_hotel where HotelId =:id";
...
<html>
<head>
<title>ImmiTours|Admin Manage Hotels</title>
...
{				?>		
						  <tr>
							...
							<td><a href="update-hotels.php?hid=<?php echo htmlentities($result->HotelId);?>"><button type="button" class="btn btn-primary btn-block">View Details</button></a><br />
