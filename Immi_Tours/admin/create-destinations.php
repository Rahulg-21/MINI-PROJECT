...
move_uploaded_file($_FILES["packimages"]["tmp_name"],"packimages/".$_FILES["packimages"]["name"]);
$sql="INSERT INTO tbl_topdestinations(PackageName,PackageType,PackageLocation,PackagePrice,PackageFetures,PackageDetails,PackageImage) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage)";
...
<html>
<head>
<title>Immi Tours|Admin Package Creation</title>
