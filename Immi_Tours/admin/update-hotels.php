...
$sql="update Tbl_Hotel set HotelName=:hname,HotelLocation=:hlocation,HotelPrice=:hprice,HotelDescription=:hdescription where HotelId=:hid";
...
<html>
<head>
<title>Immi Tours| Admin Hotel Creation</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Update Hotel </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<?php 
$hid=intval($_GET['hid']);
$sql = "SELECT * from Tbl_Hotel where HotelId=:hid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':hid', $hid, PDO::PARAM_STR);
$query->execute();
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="hotelprice" id="hotelprice" placeholder=" Hotel Price is USD" value="<?php echo htmlentities($result->HotelPrice);?>" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="hoteldescription" id="hoteldescription" placeholder="Package Features Eg-free Pickup-drop facility" value="<?php echo htmlentities($result->HotelDescription);?>" required>
									</div>
								</div>																
<div class="form-group">
<label for="focusedinput" class="col-sm-2 control-label">Hotel Image</label>
<div class="col-sm-8">
<img src="hotelimages/<?php echo htmlentities($result->HotelImage);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid=<?php echo htmlentities($result->HotelId);?>">Change Image</a>
</div>
</div>
