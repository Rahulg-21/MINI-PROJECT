...
<head>
    ...
    <!-- Title -->
    <title>Tour booking - Andtourtravel </title>
    <!-- Bootstrap css -->
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <!-- <li class="nav-item">
                                                    <a href="tour-search-map.php" class="nav-link">Tour Map</a>
                                                </li> -->
                                                <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <!-- <li class="nav-item">
                                                    <a href="hotel-map.php" class="nav-link">Hotel Map</a>
                                                </li> -->
                                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link active">Dashboard  <i class="fas fa-angle-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="tour-booking.php" class="nav-link active">Tour booking</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="common_bannner_text">
                        ...
                        <ul>
                            ...
                            <li><span><i class="fas fa-circle"></i></span><a href="dashboard.html">Customer
                                    dashboard</a></li>
                            <li><span><i class="fas fa-circle"></i></span>Tour booking</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <ul>
                                ...
                                <li class="dashboard_dropdown_button" id="dashboard_dropdowns"><i
                                    ...
                                    <div class="booing_sidebar_dashboard" id="show_dropdown_item"
                                        style="display: none;">
                                        <ul>
                                            <li><a href="hotel-booking.php"><i class="fas fa-hotel"></i>Hotel
                                                    booking</a></li>
                                            <li><a href="train-booking.php"><i class="fas fa-paper-plane"></i>Train
                                                    booking</a></li>
                                            <li>
                                                <a href="tour-booking.php" class="active">
                                                    <i class="fas fa-map"></i>Tour booking
                                                </a>
                                            </li>
                                            <li><a href="booking-history.php"><i class="fas fa-history"></i>Booking
                                                    history</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li><a href="my-profile.php"><i class="fas fa-user-circle"></i>My
                                        profile</a></li>
