                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="cruise_item_img">
                                                <img src="admin/hotelimages/<?php echo htmlentities($result->HotelImage);?>" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="cruise_item_inner_content">
                                                ...
                                                <div class="cruise_content_middel_wrapper">
                                                    ...
                                                    <div class="cruise_content_middel_right">
                                                        <h3>$<?php echo htmlentities($result->HotelPrice);?>.00 <sub>/Per person</sub></h3>
                                                ...
                                                <div class="cruise_content_bottom_wrapper">
                                                    ...
                                                    <div class="cruise_content_bottom_right">
                                                       <a href="hotel-details.php?HotelId=<?php echo htmlentities($result->HotelId);?>" class="btn btn_theme btn_md">Check availability</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>     
