...
<head>
    ...
    <!-- Title -->
    <title>Hotel search result - Immitours </title>
    <!-- Bootstrap css -->
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <!-- <li class="nav-item">
                                                    <a href="hotel-map.php" class="nav-link active">Hotel Map</a>
                                                </li> -->
                                                <li class="nav-item">
                                     ...
                                     <!--   <li class="nav-item">
                                        ...
                                        <!-- <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="nav-item">
                                                    <a href="cruise-search-list.php" class="nav-link">Cruise</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="cruise-map.php" class="nav-link">Cruise Map</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="cruise-details.php" class="nav-link">Cruise Details</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="cruise-booking.php" class="nav-link">Cruise Booking</a>
                                                </li>
                                            </ul>
                                        </li> -->
                                    </ul>
                                            ...
                                            <div class="cruise_item_inner_content">
                                                ...
                                                <div class="cruise_content_bottom_wrapper">
                                                    ...
                                                    <div class="cruise_content_bottom_right">
                                                       <a href="hotel-details.php" class="btn btn_theme btn_md">Check availability</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
