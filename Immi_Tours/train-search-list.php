...
<head>
    ...
    <!-- Title -->
    <title>Train Search list - Immitours </title>
    <!-- Bootstrap css -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        <h2>Train search result</h2>
                        <ul>
                            <li><a href="index.php">Home</a></li>
                            <li><span><i class="fas fa-circle"></i></span> Train</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="bus-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false"><i class="fas fa-bus"></i> Train</button>
                                </li>
                                ...
                                <div class="flight_search_item_wrappper">
                                    <div class="flight_search_items">
                                            ...
                                            <div class="flight_multis_area_wrapper">
                                                <div class="flight_search_left">
                                                    <div class="flight_logo">
                                                        <img src="admin/trainimages/<?php echo htmlentities($result->TrainImage);?>" alt="img">
                                                    </div>
                                                    <div class="flight_search_destination">
                                                        <p>From</p>
                                                        <h3><?php echo htmlentities($result->TrainFrom);?></h3>
                                                ...
                                                <div class="flight_search_middel">
                                                    <div class="flight_right_arrow">
                                                        ...
                                                        <h6><?php echo htmlentities($result->TrainName);?></h6>
                                                        <p>01h 05minute <?php echo htmlentities($result->TrainDuration);?> </p>
                                                    </div>
                                                    <div class="flight_search_destination">
                                                        <p>To</p>
                                                        <h3><?php echo htmlentities($result->trto);?> </h3>
                                                        <h6>Arrival time: <?php echo htmlentities($result->TrainArrival);?>pm</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flight_search_right">
                                            ...
                                            <h2>$<?php echo htmlentities($result->TrainPrice);?><sup>*20% OFF</sup></h2>
                                            <a href="train-details.php?=<?php echo htmlentities($result->TrainId);?>" class="btn btn_theme btn_sm"  data-bs-toggle="modal" data-bs-target="#staticBackdrop">Book now</a>
                                            <p>First class,second class,Third class</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="bus_seat_right_side">
                                  ...
                                  <div class="bus_ticket_continue">
                                     <a href="train-booking.php" class="btn btn_theme btn_sm">Continue</a>
                                  </div>
                                </div>
                            </div>
                        </div>
