...
<head>
    ...
    <!-- Title -->
    <title>Tour search result - Immitours </title>
    <!-- Bootstrap css -->
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="assets/img/logo-immi.png">
</head>
                    ...
                    <div class="left_side_search_area">
                        ...
                        <div class="left_side_search_boxed">
                            ...
                            <div class="name_search_form">
                                <input type="text" class="form-control" placeholder="e.g Colombo tuk tuk">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="cruise_item_img">
                                                <img src="admin/tourimages/<?php echo htmlentities($result->TourImage);?>" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="cruise_item_inner_content">
                                                <div class="cruise_content_top_wrapper">
                                                    <div class="cruise_content_top_left">
                                                        ...
                                                        <h4>Explore the <?php echo htmlentities($result->TourName);?></h4>
                                                        <p><i class="fas fa-map-marker-alt"></i> <?php echo htmlentities($result->TourLocation);?></p>
                                                    </div>
                                                    <div class="cruise_content_top_right">
                                                        <h5><?php echo htmlentities($result->TourRating);?>/5 Excellent</h5>
                                                        <h4>(1214 reviewes)</h4>
                                                    </div>
                                                </div>
                                                <div class="cruise_content_middel_wrapper">
                                                    ...
                                                    <div class="cruise_content_middel_right">
                                                        <h3>$<?php echo htmlentities($result->TourPrice);?>.00 <sub>/Per person</sub></h3>
                                                ...
                                                <div class="cruise_content_bottom_wrapper">
                                                    ...
                                                    <div class="cruise_content_bottom_right">
                                                        <a href="tour-details.php?TourId=<?php echo htmlentities($result->TourId);?>" class="btn btn_theme btn_md">View details</a>
                                                     </div>
                                                </div>
                                            </div>
                                        </div>
