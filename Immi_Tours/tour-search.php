...
<head>
    ...
    <!-- Title -->
    <title>Tour Search - Immitours </title>
    <!-- Bootstrap css -->
                    ...
                    <div class="left_side_search_area">
                        ...
                        <div class="left_side_search_boxed">
                            ...
                            <div class="name_search_form">
                                <input type="text" class="form-control" placeholder="e.g Tuk Tuk">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="theme_common_box_two">
                                <div class="theme_two_box_img">
                                    <a href="tour-details.php?TourId=<?php echo htmlentities($result->TourId);?>"><img src="admin/tourimages/<?php echo htmlentities($result->TourImage);?>" alt="img"></a>
                                    <p><i class="fas fa-map-marker-alt"></i><?php echo htmlentities($result->TourLocation);?></p>
                                </div>
                                <div class="theme_two_box_content">
                                    <h4><a href="tour-details.php?TourId=<?php echo htmlentities($result->TourId);?>"><?php echo htmlentities($result->TourName);?></a></h4>
                                    <p><span class="review_rating"><?php echo htmlentities($result->TourRating);?>/5</span> <span
                                            class="review_count">(1214
                                            reviewes)</span></p>
                                    <h3>$<?php echo htmlentities($result->TourPrice);?>.00 <span>Price starts from</span></h3>
                                </div>
                            </div>
                        </div>
                    <?php }} ?>
