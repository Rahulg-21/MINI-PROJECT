                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="holiday_small_boxed">
                                <a href="top-destinations-details.php">
                                    <img src="assets/img/holiday-img/sigiriya.jpg" alt="img">
                            ...
                            <div class="holiday_small_boxed">
                                <a href="top-destinations-details.php">
                                    <img src="assets/img/holiday-img/retreat1.jpg" alt="img">
                                    <div class="holiday_small_box_content">
                                        <div class="holiday_inner_content">
                                            <div class="rating_outof">
                                                <i class="fas fa-star"></i>
                        ...
                        <div class="col-lg-6">
                            <div class="holiday_small_boxed">
                                <a href="top-destinations-details.php">
                                    <img src="assets/img/holiday-img/mirissa.jpg" alt="img">
                                    <div class="holiday_small_box_content">
                                        <div class="holiday_inner_content">
                                            <div class="rating_outof">
                                                <i class="fas fa-star"></i>
                                            ...
                                            <h3>Excursion to Mirissa | $200</h3>
                                            <h4>5D/4N</h4>
                                            <p>Cupidatat consectetur ea cillum nt
                                                consectetur excepteur.</p>
                                        </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="holiday_small_boxed">
                                <a href="top-destinations-details.php">
                                    <img src="assets/img/holiday-img/bentotabeach.jpg" alt="img">
                                    <div class="holiday_small_box_content">
                                        <div class="holiday_inner_content">
                                            <div class="rating_outof">
                                                <i class="fas fa-star"></i>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="holiday_small_boxed">
                                        <a href="top-destinations-details.php">
                                            <img src="assets/img/holiday-img/ninearch.jpg" alt="img">
                                            <div class="holiday_small_box_content">
                                                <div class="holiday_inner_content">
                                                    <div class="rating_outof">
                                                        <i class="fas fa-star"></i>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="holiday_small_boxed">
                                        <a href="top-destinations-details.php">
                                            <img src="assets/img/holiday-img/romantic.jpg" alt="img">
                                            <div class="holiday_small_box_content">
                                                <div class="holiday_inner_content">
                                                    <div class="rating_outof">
                                                        <i class="fas fa-star"></i>
            ...
            <div class="row">
                    ...
                    <div class="choose_desti_wrapper">
                        <div class="choose_des_inner_wrap">
                            <div class="choose_boxed_inner">
                                <img src="assets/img/destination/wild.jpg" alt="img">
                                <div class="choose_img_text">
                                    <h2>Wildlife | $13,500</h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="choose_desti_wrapper">
                        <div class="choose_des_inner_wrap">
                            <div class="choose_boxed_inner">
                                <img src="assets/img/destination/beach.jpg" alt="img">
                                <div class="choose_img_text">
                                    <h2>Beach | $3,500</h2>
                                    <h3>7 days 6 nights</h3>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="choose_desti_wrapper">
                        <div class="choose_des_inner_wrap">
                            <div class="choose_boxed_inner">
                                <img src="assets/img/destination/galle1.jpg" alt="img">
                                <div class="choose_img_text">
                                    <h2>Galle Fort | $2,500</h2>
                                    <h3>7 days 6 nights</h3>
                                </div>
                            </div>
                            <div class="flep_choose_box">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="choose_desti_wrapper">
                        <div class="choose_des_inner_wrap">
                            <div class="choose_boxed_inner">
                                <img src="assets/img/destination/ella1.jpg" alt="img">
                                <div class="choose_img_text">
                                    <h2>Adams Peak Ella | $6,000</h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="choose_desti_wrapper">
                        <div class="choose_des_inner_wrap">
                            <div class="choose_boxed_inner">
                                <img src="assets/img/destination/JetavaranamaAnuradhapura1.jpg" alt="img">
                                <div class="choose_img_text">
                                    <h2>Anuradhapura | $3,500</h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="choose_desti_wrapper">
                        <div class="choose_des_inner_wrap">
                            <div class="choose_boxed_inner">
                                <img src="assets/img/destination/jaffna1.jpg" alt="img">
                                <div class="choose_img_text">
                                    <h2>Jaffna | $4,200</h2>
