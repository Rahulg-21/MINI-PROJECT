...
<div class="row g-4 align-items-center">
    ...
    <div class="col-md-3 text-center">
        <img src="<?php echo !empty($guide['image']) ? '../GUIDE/uploads/guides/'.$guide['image'] : 'assets/default_guide.png'; ?>" 
             ...
             style="width:150px; height:150px; object-fit:cover;" alt="Guide">
    </div>

    <!-- Guide Info + Familiar Spot -->
    <div class="col-md-9">
        <div class="row g-3">
            <!-- Guide Info -->
            <div class="col-md-6">
                ...
                <p class="mb-1 text-muted"><em>Familiar with all spots in this <?php echo $guide['district_name']; ?>.</em></p>
            </div>

            <!-- Most Familiar Spot -->
            <div class="col-md-6">
                <h5>Most familiar with:</h5>
                <?php if (!empty($guide['spot_name'])): ?>
                    <div class="card text-center">
                        <img src="../ADMIN/uploads/tourist_spots/<?php echo $guide['spot_image']; ?>" 
                             class="card-img-top rounded-circle mx-auto mt-3" 
                             style="width:150px; height:150px; object-fit:cover;" alt="<?php echo $guide['spot_name']; ?>">
                        <div class="card-body">
                            <h6 class="card-title"><?php echo $guide['spot_name']; ?></h6>
                            <p class="text-muted mb-0">Located in <?php echo $guide['district_name']; ?></p>
                        </div>
                    </div>
                <?php else: ?>
                    <p class="text-muted">No specific spot highlighted.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
